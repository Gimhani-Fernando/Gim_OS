;*****************start of the kernel code of Gim_OS***************
[org 0x000]
[bits 16]
...
;***************************************************************************************
;display the hardaware information - invoked by info command
...
[SEGMENT .data]
	strWelcomeMsg		db	"Welcome to Gim_OS version 1.0.0", 0x00

	wel1 db	'----------------------------------------------', 0x00			

	wel2 db '*********** WELCOME TO Gim_OS ************', 0x00 
	...
	wel7 db ' version 1.0.0 of Gim_OS From G.A.Fernando', 0x00
	...
	strPrompt		db	"Gim_OS>>", 0x00
	cmdMaxLen		db	255			;maximum length of commands

	strOsName		db	"Gim", 0x00	;OS details
